...
# 新版 baostock(0.9.x) 收紧访问后支持的 API Key，登录前通过 set_API_key 传入；
...
# ========== 行情源健康评分（第一阶段：内存观察，不落库） ==========
MARKET_HEALTH_ENABLED = True
MARKET_HEALTH_OBSERVE_ONLY = False
MARKET_HEALTH_WINDOW_SECONDS = 300
MARKET_HEALTH_MAX_EVENTS = 100
MARKET_HEALTH_MIN_EVENTS = 3
MARKET_HEALTH_HEALTHY_SCORE = 80
MARKET_HEALTH_DEGRADED_SCORE = 60
MARKET_HEALTH_UNSTABLE_SCORE = 40
MARKET_HEALTH_TRADING_MIN_SCORE = 70
